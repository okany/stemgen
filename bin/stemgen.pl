...
#### Lecture Notes in Computer Science, Vol. 5791/2009, Sept. 2009, pp 86-94.
####
...
#
# This function runs a stmmer specified on the command line
#
sub run_stemmer() {
...
#
# This function generated a new stemmer by using the rule file specified in the command line
#
...
#
# This function generates the following stemming algorithms by using the stemgen application generator
#   - porter
#   - lovins
#   - paice
#   - sremoval
#   - successor variety
#   - kstem
# after generating each of these stemming algorithms, it tests them for all the words in w.txt file
# finally cleans up the code generated by the application generator
#
sub test_all() {
